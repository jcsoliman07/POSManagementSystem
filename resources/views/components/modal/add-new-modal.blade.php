...
<div id="add-new-modal" tabindex="-1" aria-hidden="true" class="fixed inset-0 z-50 flex items-start justify-center pt-20 bg-black bg-opacity-50 opacity-0 pointer-events-none transition-opacity duration-300 ease-out">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-custom-light-gray rounded-lg shadow-lg">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t border-gray-200">
                ...
                <x-nav-heading>Add New</x-nav-heading>
                ...
                <button type="button" 
                        ...
                        onclick="closeModal()"> <!-- The Modal will close when it's click -->
            ...
            <x-forms.form method="POST" action="/category" >
                ...
                <div class="p-4 flex flex-col h-full">
                    ...
                    <div class="mt-4 flex gap-2 justify-end">
                        <x-buttons.button-cancel onclick="closeModal()">Cancel</x-buttons.button-cancel>
