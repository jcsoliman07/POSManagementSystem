...
<div class="sidebar bg-custom-gray text-custom-dark-gray w-64 min-h-screen flex flex-col shadow-lg z-10">
    ...
    <div class="flex-1 overflow-y-auto py-4">
        ...
        <x-navigation.nav-items href="/" icon="fas fa-tachometer-alt text-custom-yellow">Dashboard</x-navigation.nav-items>
        <x-navigation.nav-items href="#" icon="fas fa-shopping-cart text-custom-yellow">Order Management</x-navigation.nav-items>
        <x-navigation.nav-items href="#" icon="fas fa-box-open mr-2 text-custom-yellow">Product Management</x-navigation.nav-items>
        <x-navigation.nav-items href="/category" icon="fas fa-tags mr-2 text-custom-yellow">Category Management</x-navigation.nav-items>
